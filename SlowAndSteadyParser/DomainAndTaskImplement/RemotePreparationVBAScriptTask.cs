...
{
    [Serializable]
    public class RemotePreparationVBAScriptTask : BaseVBAScriptTask , IRemoteTask
    {
        ...
        public override List<ITask> NextTasks()
        {
            ...
            if (d!=null)
            {
                ltask.Add(new RemoteParserVBAScriptTask(m_domainGUID, m_taskchainGUID, m_vbaobjs));
                m_vbaobjs = null;
            }
            return ltask;
        }
        ...
        public override string Name { get { return "Remote Preparation Task"; } }
        ...
        /// 构造函数(无参数)
        /// </summary>
        public RemotePreparationVBAScriptTask() : base()
        {
        ...
        /// </summary>
        public RemotePreparationVBAScriptTask(string dGUID, Dictionary<string, IVBAObject> vobjs) : base(dGUID, vobjs)
        {
            if (vobjs == null)
        ...
        protected RemotePreparationVBAScriptTask(SerializationInfo s, StreamingContext c)
            : base(s, c)
        {
        ...
        public object Clone()
        {
            RemotePreparationVBAScriptTask t = new RemotePreparationVBAScriptTask();
