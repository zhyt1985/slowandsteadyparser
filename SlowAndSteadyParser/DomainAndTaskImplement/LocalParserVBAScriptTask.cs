...
{
    [Serializable]
    public class LocalParserVBAScriptTask : BaseVBAScriptTask, IRemoteTask, ISerializable
    {
        ...
        public override string Name { get { return "Local Parser Task"; } }

        #region 构造函数 **********************************************************
        /// <summary>
        /// 构造函数(无参数)
        /// </summary>
        public LocalParserVBAScriptTask() : base()
        {
        ...
        /// </summary>
        public LocalParserVBAScriptTask(string dGUID, Dictionary<string, IVBAObject> vobjs) : base(dGUID,vobjs)
        {
        ...
        /// </summary>
        public LocalParserVBAScriptTask(string dGUID, string tcGUID, Dictionary<string, IVBAObject> vobjs)
            : base(dGUID, tcGUID, vobjs)
        {
        }


        protected LocalParserVBAScriptTask(SerializationInfo s, StreamingContext c)
            : base(s, c)
        {
        ...
        public object Clone()
        {
            LocalParserVBAScriptTask t = new LocalParserVBAScriptTask();
