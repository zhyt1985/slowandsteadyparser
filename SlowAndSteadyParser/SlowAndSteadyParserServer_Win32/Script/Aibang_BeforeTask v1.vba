...
If Not City Is Nothing Then
	...
	'生成任务URL
	Task.URl = "http://www.aibang.com/?area=bizsearch&cmd=bigmap&city=" + Task.UnicodeToUTF8(City)
	Task.URL = Task.URL + "&a=" + Task.UnicodeToUTF8(Poi) + "&q=" + Task.UnicodeToUTF8(Category)
