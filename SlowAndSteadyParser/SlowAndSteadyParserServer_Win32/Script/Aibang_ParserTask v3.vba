...
Do
		...
		While Web.ElementPointMoveNextCondition(Web.ElementSeekClassName("td_top")+Web.ElementSeekInnerHTML("select_biz", false))				
			...
			Web.ElementPointPushRangeChildren()
				...
				Web.ElementPointPushRangeChildren()				
					...
					'取得店URL
					AibangURL = Utility.ConvertHrefToAbsoluteURL(Web.GetCurrentURL(), Web.ElementPointHref)
					'从AibangURL中提取AibangId
					AibangIdParser = Utility.ConvertURLToQueryString(AibangURL)
	...
	Web.ElementPointPushRangeLinks()
		...
		'从相对URL转换到绝对URL
		NewURL = Utility.ConvertHrefToAbsoluteURL(Web.GetCurrentURL(), Web.ElementPointHref)
