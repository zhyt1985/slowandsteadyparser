...
namespace log4net.Appender
{
    ...
    public class RichTextBoxAppender : AppenderSkeleton
    {
        ...
        public RichTextBox RichTextBox
        {
            set
            {
                if (!object.ReferenceEquals(value, _richtextBox))
                {
                    ...
                    {
                        _containerForm.FormClosed -= new
                        FormClosedEventHandler(containerForm_FormClosed);
                        _containerForm = null;
                    }
        ...
        /// <summary>
        /// This method is called by the <seecref="AppenderSkeleton.DoAppend(log4net.Core.LoggingEvent)"/> method.
        /// </summary>
        ...
        protected override void Append(LoggingEvent LoggingEvent)
        {
            if (_richtextBox != null)
            {
                ...
                {
                    _richtextBox.BeginInvoke( new UpdateControlDelegate(UpdateControl), new object[] { LoggingEvent });
                }
                else
                {
        ...
        private void UpdateControl(LoggingEvent loggingEvent)
        {
            ...
            _levelMapping.Lookup(loggingEvent.Level) as LevelTextStyle;
